                ...
                <form id="checkout-form" onSubmit={props.handleSubmit}>
                    ...
                    <fieldset id="guest-details">
                        ...
                        <div className="label-input" id="form-county">
                            ...
                            <input type="text" id="customer-county" name="customer-county" required />
                        </div>
                        ...
                        <div className="label-input" id="form-country">
                            ...
                            <select id="customer-country" name="customer-country" required defaultValue={"KE"}>
                                ...
                                <option value="CG">Congo-Brazzaville (Republic of the Congo)</option>
                                <option value="CD">Congo-Kinshasa (Democratic Republic of the Congo)</option>
                        ...
                        <div className="label-input" id="form-phone">
                            ...
                            <input type="tel" id="customer-phone" name="customer-phone" placeholder="(+254) 700 000 000" required />
                        </div>
                    ...
                    <fieldset id="additional-info">
                        ...
                        <div className="label-input" id="form-arrival">
                            <label htmlFor="customer-arrival">Estimated time of arrival</label>
                            <input type="time" id="customer-arrival" name="customer-arrival" min="09:00" max="18:00" defaultValue="12:00" />
                        </div>

                        <div className="label-input" id="form-requests">
                            <label htmlFor="customer-requests">Special requests</label>
                            <textarea id="customer-requests" name="customer-request" placeholder="Kindly provide additional details if needed"></textarea>
                        </div>
                    </fieldset>
                    ...
                    <fieldset id="payment-method">
                        ...
                        <div className="methods">
                            ...
                            <div className="label-input radio">
                                <input type="radio" id="credit-debit" name="credit-debit" defaultValue="credit-debit" defaultChecked />
                                <label htmlFor="credit-debit">Credit/debit card</label>
                            </div>
                            <div className="label-input radio">
                                <input type="radio" id="mpesa" name="mpesa" defaultValue="mpesa" />
